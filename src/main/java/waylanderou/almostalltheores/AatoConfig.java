...
public class AatoConfig {
	...
	static {
		...
		hookNether = BUILDER.comment("Handle all underground ore generation in Nether dimension. Currently not useful. (true/false | default: true)").define("hookNether", false);
		hookEnd = BUILDER.comment("Handle all underground ore generation in End dimension. Currently not useful. (true/false | default: false)").define("hookEnd", false);
