...
public class OreGeneration {
	...
	public static void setup() {
		for(Biome biome: ForgeRegistries.BIOMES.getValues()) {
			...
			if(Config.handleEverythingInOverworld.get()) {
				biome.getFeatures(GenerationStage.Decoration.UNDERGROUND_ORES).clear();
			} else {
	...
	private static void addAatoOverworldGeneration(Biome biome) {		
		if(Config.All.get() || Config.enablePGMs.get() || Config.enabledPGMs.get()) {
			if(!Config.blacklistCommonPGMsOres.get().contains(biome.getRegistryName().toString()))
		...
		if(Config.All.get() || Config.enableRarePGMs.get() || Config.enabledRarePGMs.get()) {
			if(!Config.blacklistRarePGMsOres.get().contains(biome.getRegistryName().toString()))
		...
		if(Config.All.get() || Config.enablePyrite.get() || Config.enableSulphurOres.get()) {
			if(!Config.blacklistSulfurOres.get().contains(biome.getRegistryName().toString()))
		...
		if(Config.All.get() || Config.enableGuano.get() || Config.enableNPKOres.get()) {
			if(!Config.blacklistNPKOres.get().contains(biome.getRegistryName().toString()))
		...
		if(Config.All.get() || Config.enableLignite_ore.get() || Config.enableCoalOres.get()) {
			if(!Config.blacklistLigniteOre.get().contains(biome.getRegistryName().toString()))
		...
		if(Config.All.get() || Config.enableBituminous_coal_ore.get() || Config.enableCoalOres.get()) {
			if(!Config.blacklistBituminousCoalOre.get().contains(biome.getRegistryName().toString()))
		...
		if(Config.All.get() || Config.enableAnthracite_ore.get() || Config.enableCoalOres.get()) {
			if(!Config.blacklistAnthraciteOre.get().contains(biome.getRegistryName().toString()))
		...
		if(Config.All.get() || Config.enableGraphite.get() || Config.enableGraphiteOre.get()) { 
			if(!Config.blacklistGraphiteOre.get().contains(biome.getRegistryName().toString()))
		...
		if(Config.All.get() || Config.enableCassiterite.get() || Config.enableTinOres.get()) {
			if(!Config.blacklistTinOres.get().contains(biome.getRegistryName().toString()))
		...
		if(Config.All.get() || Config.enableGalena.get() || Config.enableLeadOres.get()) {
			if(!Config.blacklistLeadOres.get().contains(biome.getRegistryName().toString()))
		...
		if(Config.All.get() || Config.enableBauxite.get() || Config.enableAluminumOres.get()) {
			if(!Config.blacklistAluminiumOres.get().contains(biome.getRegistryName().toString()))
		...
		if(Config.All.get() || Config.enableSphalerite.get() || Config.enableZincOres.get()) {
			if(!Config.blacklistZincOres.get().contains(biome.getRegistryName().toString()))
		...
		if(Config.All.get() || Config.enableCinnabar.get() || Config.enableMercuryOres.get()) {
			if(!Config.blacklistMercuryOres.get().contains(biome.getRegistryName().toString()))
		...
		if(Config.All.get() || Config.enableChalcopyrite.get() || Config.enableCopperOres.get()) {
			if(!Config.blacklistCopperOres.get().contains(biome.getRegistryName().toString()))
		...
		if(Config.All.get() || Config.enableNative_silver.get() || Config.enableSilverOres.get()) {
			if(!Config.blacklistSilverOres.get().contains(biome.getRegistryName().toString()))
		...
		if(Config.All.get() || Config.enableNickeline.get() || Config.enableNickelOres.get()) {
			if(!Config.blacklistNickelOres.get().contains(biome.getRegistryName().toString()))
		...
		if(Config.All.get() || Config.enableCobaltite.get() || Config.enableCobaltOres.get()) {
			if(!Config.blacklistCobaltOres.get().contains(biome.getRegistryName().toString()))
		...
		if(Config.All.get() || Config.enableHematite.get() || Config.enableIronOres.get()) {
			if(!Config.blacklistIronOres.get().contains(biome.getRegistryName().toString()))
		...
		if(Config.All.get() || Config.enablePyrolusite.get() || Config.enableManganeseOres.get()) {
			if(!Config.blacklistManganeseOres.get().contains(biome.getRegistryName().toString()))
		...
		if(Config.All.get() || Config.enableChromite.get() || Config.enableChromiumOres.get()) {
			if(!Config.blacklistChromiumOres.get().contains(biome.getRegistryName().toString()))
		...
		if(Config.All.get() || Config.enableMolybdenite.get() || Config.enableMolybdenumOres.get()) {
			if(!Config.blacklistMolybdenumOres.get().contains(biome.getRegistryName().toString()))
		...
		if(Config.All.get() || Config.enableScheelite.get() || Config.enableTungstenOres.get()) {
			if(!Config.blacklistTungstenOres.get().contains(biome.getRegistryName().toString()))
		...
		if(Config.All.get() || Config.enableVanadinite.get() || Config.enableVanadiumOres.get()) {
			if(!Config.blacklistVanadiumOres.get().contains(biome.getRegistryName().toString()))
		...
		if(Config.All.get() || Config.enableColumbite.get() || Config.enableNiobiumOres.get()) {
			if(!Config.blacklistNiobiumOres.get().contains(biome.getRegistryName().toString()))
		...
		if(Config.All.get() || Config.enableTantalite.get() || Config.enableTantalumOres.get()) {
			if(!Config.blacklistTantalumOres.get().contains(biome.getRegistryName().toString()))
		...
		if(Config.All.get() || Config.enableRutile.get() || Config.enableTitaniumOres.get()) {
			if(!Config.blacklistTitaniumOres.get().contains(biome.getRegistryName().toString()))
		...
		if(Config.All.get() || Config.enableZircon.get() || Config.enableZirconiumOres.get()) {
			if(!Config.blacklistZirconiumOres.get().contains(biome.getRegistryName().toString()))
		...
		if(Config.All.get() || Config.enableThorite.get() || Config.enableThoriumOres.get()) {
			if(!Config.blacklistThoriumOres.get().contains(biome.getRegistryName().toString()))
		...
		if(Config.All.get() || Config.enableCarnotite.get() || Config.enableUraniumOres.get()) {
			if(!Config.blacklistUraniumOres.get().contains(biome.getRegistryName().toString()))
		...
		if(Config.All.get() || Config.enableMagnesite.get() || Config.enableMagnesiumOres.get()) {
			if(!Config.blacklistMagnesiumOres.get().contains(biome.getRegistryName().toString()))
		...
		if(Config.All.get() || Config.enableCalcite.get() || Config.enableCalciumOres.get()) {
			if(!Config.blacklistCalciumOres.get().contains(biome.getRegistryName().toString()))
		...
		if(Config.All.get() || Config.enableStrontianite.get() || Config.enableStrontiumOres.get()) {
			if(!Config.blacklistStrontiumOres.get().contains(biome.getRegistryName().toString()))
		...
		if(Config.All.get() || Config.enablePolylithionite.get() || Config.enableLithiumOres.get()) {
			if(!Config.blacklistLithiumOres.get().contains(biome.getRegistryName().toString()))
		...
		if(Config.All.get() || Config.enableHalite.get() || Config.enableSaltOre.get()) {
			if(!Config.blacklistSaltOre.get().contains(biome.getRegistryName().toString()))			
		...
		if(Config.All.get() || Config.enableChrysocolla_ore.get() || Config.enableAllGems.get() || (Config.enableStoneAge.get() && Config.enablePlugAndPlay.get())) {
			if(!Config.blacklistChrysocollaOre.get().contains(biome.getRegistryName().toString()))
		...
		if(Config.All.get() || Config.enableMithril_ore.get() || Config.enableMithrilOre.get()) {
			if(!Config.blacklistMithrilOre.get().contains(biome.getRegistryName().toString()))
		...
		if(biome.getTempCategory() == TempCategory.MEDIUM) {
			...
			if(Config.All.get() || Config.enableGreenockite.get() || Config.enableCadmiumOres.get()) {
				if(!Config.blacklistCadmiumOres.get().contains(biome.getRegistryName().toString()))
		...
		if(biome.getDownfall() < 0.25F) {
			if(Config.All.get() || Config.enableNitratine.get() || Config.enableSaltpetreOre.get()) {
				if(!Config.blacklistSaltpetreOre.get().contains(biome.getRegistryName().toString()))
		...
		if(biome.getTempCategory() != TempCategory.WARM && biome.getTempCategory() != TempCategory.OCEAN && biome.getDownfall() > 0.75F) { //forest 0.8 ...
			if(Config.All.get() || Config.enablePeat.get() || Config.enableCoalOres.get()) {
				if(!Config.blacklistPeatOre.get().contains(biome.getRegistryName().toString()))				
	...
	private static void handleInfestedStone(Biome biome) {
		...
		if(biome == Biomes.GRAVELLY_MOUNTAINS || biome == Biomes.MODIFIED_GRAVELLY_MOUNTAINS || biome == Biomes.MOUNTAIN_EDGE || biome == Biomes.MOUNTAINS || biome == Biomes.WOODED_MOUNTAINS) {
			...
			if(biome.getFeatures(GenerationStage.Decoration.UNDERGROUND_DECORATION).removeAll(featuresToRemove)) {
				if(Config.enableInfestedStone.get()) {
	...
	private static void addVanillaStuff(Biome biome) {
		if(Config.enableVanillaIronOre.get()) {
			if(!Config.blacklistIronOres.get().contains(biome.getRegistryName().toString()))
		...
		if(Config.enableVanillaCoalOre.get()) {
			if(!Config.blacklistBituminousCoalOre.get().contains(biome.getRegistryName().toString()))
		...
		if(Config.enableGold.get()) {
			if(!Config.blacklistGoldOre.get().contains(biome.getRegistryName().toString()))
		...
		if(Config.enableRedstone.get()) {
			if(!Config.blacklistRedstoneOre.get().contains(biome.getRegistryName().toString()))
		...
		if(Config.enableDiamond.get()) {
			if(!Config.blacklistDiamondOre.get().contains(biome.getRegistryName().toString()))			
		...
		if(Config.enableLapis.get()) {
			if(!Config.blacklistLapisOre.get().contains(biome.getRegistryName().toString()))			
