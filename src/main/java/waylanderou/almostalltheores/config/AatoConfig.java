...
public class AatoConfig {
	...
	public static BooleanValue triangleLapis;
	...
	static {
		...
		copperHL = BUILDER.comment("Copper ores harvest level").defineInRange("copperHarvestLevel", 2, 0, 5);
		...
		MinHeightCoal = BUILDER.comment("Minimum Height").defineInRange("MinHeightCoalOre", 0, -64, 255);
		MaxHeightCoal = BUILDER.comment("Maximum Height").defineInRange("MaxHeightCoalOre", 192, -64, 255);
		BUILDER.pop();
		...
		MinHeightIron = BUILDER.comment("Minimum Height").defineInRange("MinHeightIronOre", -60, -64, 255);
		MaxHeightIron = BUILDER.comment("Maximum Height").defineInRange("MaxHeightIronOre", 255, -64, 255);
		BUILDER.pop();
		...
		MinHeightGold = BUILDER.comment("Minimum Height").defineInRange("MinHeightGold", -60, -64, 255);
		MaxHeightGold = BUILDER.comment("Maximum Height").defineInRange("MaxHeightGold", 32, -64, 255);
		BUILDER.pop();
		...
		MinHeightBadlandsGold = BUILDER.comment("Minimum Height badlands gold").defineInRange("MinHeightBadlandsGold", 32, -64, 255);
		MaxHeightBadlandsGold = BUILDER.comment("Maximum Height badlands gold").defineInRange("MaxHeightBadlandsGold", 255, -64, 255);
		BUILDER.pop();
		...
		MinHeightRedstone = BUILDER.comment("Minimum Height").defineInRange("MinHeightRedstone", -60, -64, 255);
		MaxHeightRedstone = BUILDER.comment("Maximum Height").defineInRange("MaxHeightRedstone", 16, -64, 255);
		BUILDER.pop();
		...
		VeinsPerChunkDiamond = BUILDER.comment("Veins per chunk").defineInRange("VeinsPerChunkDiamond", 4, 0, 50);
		MinHeightDiamond = BUILDER.comment("Minimum Height").defineInRange("MinHeightDiamond", -60, -64, 255);
		MaxHeightDiamond = BUILDER.comment("Maximum Height").defineInRange("MaxHeightDiamond", 16, -64, 255);
		BUILDER.pop();
		...
		VeinsPerChunkLapis = BUILDER.comment("Veins per chunk").defineInRange("VeinsPerChunkLapis", 6, 0, 50);
		DepthAverageLapis = BUILDER.comment("Depth average of lapis lazuli ores").defineInRange("DepthAverageLapis", 16, -64, 255);
		triangleLapis = BUILDER.comment("Enable triangle generation for lapis ore").define("triangleLapis", true);
		BUILDER.pop();
		...
		MinHeightDirt = BUILDER.comment("Minimum Height").defineInRange("MinHeightDirt", 0, -64, 255);
		MaxHeightDirt = BUILDER.comment("Maximum Height").defineInRange("MaxHeightDirt", 255, -64, 255);
		BUILDER.pop();
		...
		MinHeightGravel = BUILDER.comment("Minimum Height").defineInRange("MinHeightGravel", 0, -64, 255);
		MaxHeightGravel = BUILDER.comment("Maximum Height").defineInRange("MaxHeightGravel", 255, -64, 255);
		BUILDER.pop();
		...
		MinHeightGranite = BUILDER.comment("Minimum Height").defineInRange("MinHeightGranite", 10, -64, 255);
		MaxHeightGranite = BUILDER.comment("Maximum Height").defineInRange("MaxHeightGranite", 80, -64, 255);
		BUILDER.pop();
		...
		MinHeightDiorite = BUILDER.comment("Minimum Height").defineInRange("MinHeightDiorite", 10, -64, 255);
		MaxHeightDiorite = BUILDER.comment("Maximum Height").defineInRange("MaxHeightDiorite", 80, -64, 255);
		BUILDER.pop();
		...
		MinHeightAndesite = BUILDER.comment("Minimum Height").defineInRange("MinHeightAndesite", 10, -64, 255);
		MaxHeightAndesite = BUILDER.comment("Maximum Height").defineInRange("MaxHeightAndesite", 80, -64, 255);
		BUILDER.pop();	

		BUILDER.push("infestedstone");
		enableInfestedStone = BUILDER.comment("Enable infested stone generation").define("enableInfestedStone", false);
		...
		MinHeightInfestedStone = BUILDER.comment("Minimum Height").defineInRange("MinHeightInfestedStone", -64, -64, 255);
		MaxHeightInfestedStone = BUILDER.comment("Maximum Height").defineInRange("MaxHeightInfestedStone", 255, -64, 255);		
		BUILDER.pop();
		...
		MinHeightPyrite = BUILDER.comment("Minimum Height").defineInRange("MinHeightPyrite", 20, -64, 255);
		MaxHeightPyrite = BUILDER.comment("Maximum Height").defineInRange("MaxHeightPyrite", 192, -64, 255);
		BUILDER.pop();
		...
		MinHeightSulphur = BUILDER.comment("Minimum Height").defineInRange("MinHeightSulphur", 30, -64, 255);
		MaxHeightSulphur = BUILDER.comment("Maximum Height").defineInRange("MaxHeightSulphur", 255, -64, 255);
		BUILDER.pop();
		...
		VeinsPerChunkKimberlite = BUILDER.comment("Veins per chunk").defineInRange("VeinsPerChunkKimberlite", 2, 0, 50);
		MinHeightKimberlite = BUILDER.comment("Minimum Height").defineInRange("MinHeightKimberlite", -60, -64, 255);
		MaxHeightKimberlite = BUILDER.comment("Maximum Height").defineInRange("MaxHeightKimberlite", 16, -64, 255);
		BUILDER.pop();
		...
		VeinsPerChunkLamproite = BUILDER.comment("Veins per chunk").defineInRange("VeinsPerChunkLamproite", 2, 0, 50);
		MinHeightLamproite = BUILDER.comment("Minimum Height").defineInRange("MinHeightLamproite", -60, -64, 255);
		...
		MinHeightClausthalite = BUILDER.comment("Minimum Height").defineInRange("MinHeightClausthalite", 40, -64, 255);
		MaxHeightClausthalite = BUILDER.comment("Maximum Height").defineInRange("MaxHeightClausthalite", 90, -64, 255);
		BUILDER.pop();

		BUILDER.push("guano");
		enableGuano = BUILDER.comment("Enable guano generation").define("enableGuano", false);
		VeinSizeGuano = BUILDER.comment("Vein Size").defineInRange("VeinSizeGuano", 10, 0, 50);
		VeinsPerChunkGuano = BUILDER.comment("Veins per chunk").defineInRange("VeinsPerChunkGuano", 5, 0, 50);
		MinHeightGuano = BUILDER.comment("Minimum Height").defineInRange("MinHeightGuano", 40, -64, 255);
		MaxHeightGuano = BUILDER.comment("Maximum Height").defineInRange("MaxHeightGuano", 255, -64, 255);
		BUILDER.pop();

		BUILDER.push("phosphorite");
		enablePhosphorite = BUILDER.comment("Enable phosphorite generation").define("enablePhosphorite", false);
		VeinSizePhosphorite = BUILDER.comment("Vein Size").defineInRange("VeinSizePhosphorite", 10, 0, 50);
		VeinsPerChunkPhosphorite = BUILDER.comment("Veins per chunk").defineInRange("VeinsPerChunkPhosphorite", 5, 0, 50);
		MinHeightPhosphorite = BUILDER.comment("Minimum Height").defineInRange("MinHeightPhosphorite", 40, -64, 255);
		MaxHeightPhosphorite = BUILDER.comment("Maximum Height").defineInRange("MaxHeightPhosphorite", 255, -64, 255);
		BUILDER.pop();
		...
		MinHeightPeat = BUILDER.comment("Minimum Height").defineInRange("MinHeightPeat", 50, -64, 255);
		MaxHeightPeat = BUILDER.comment("Maximum Height").defineInRange("MaxHeightPeat", 85, -64, 255);
		BUILDER.pop();
		...
		MinHeightLignite_ore = BUILDER.comment("Minimum Height").defineInRange("MinHeightLignite_ore", 0, -64, 255);
		MaxHeightLignite_ore = BUILDER.comment("Maximum Height").defineInRange("MaxHeightLignite_ore", 192, -64, 255);
		BUILDER.pop();
		...
		MinHeightBituminous_coal_ore = BUILDER.comment("Minimum Height").defineInRange("MinHeightBituminous_coal_ore", 0, -64, 255);
		MaxHeightBituminous_coal_ore = BUILDER.comment("Maximum Height").defineInRange("MaxHeightBituminous_coal_ore", 192, -64, 255);
		BUILDER.pop();
		...
		MinHeightAnthracite_ore = BUILDER.comment("Minimum Height").defineInRange("MinHeightAnthracite_ore", 0, -64, 255);
		MaxHeightAnthracite_ore = BUILDER.comment("Maximum Height").defineInRange("MaxHeightAnthracite_ore", 192, -64, 255);
		BUILDER.pop();
		...
		MinHeightGraphite = BUILDER.comment("Minimum Height").defineInRange("MinHeightGraphite", -10, -64, 255);
		MaxHeightGraphite = BUILDER.comment("Maximum Height").defineInRange("MaxHeightGraphite", 60, -64, 255);
		BUILDER.pop();
		...
		MinHeightLollingite = BUILDER.comment("Minimum Height").defineInRange("MinHeightLollingite", 0, -64, 255);
		MaxHeightLollingite = BUILDER.comment("Maximum Height").defineInRange("MaxHeightLollingite", 50, -64, 255);
		BUILDER.pop();
		...
		MinHeightRealgar = BUILDER.comment("Minimum Height").defineInRange("MinHeightRealgar", 0, -64, 255);
		MaxHeightRealgar = BUILDER.comment("Maximum Height").defineInRange("MaxHeightRealgar", 50, -64, 255);
		BUILDER.pop();
		...
		MinHeightOrpiment = BUILDER.comment("Minimum Height").defineInRange("MinHeightOrpiment", 0, -64, 255);
		MaxHeightOrpiment = BUILDER.comment("Maximum Height").defineInRange("MaxHeightOrpiment", 50, -64, 255);
		BUILDER.pop();
		...
		MinHeightArsenopyrite = BUILDER.comment("Minimum Height").defineInRange("MinHeightArsenopyrite", 0, -64, 255);
		MaxHeightArsenopyrite = BUILDER.comment("Maximum Height").defineInRange("MaxHeightArsenopyrite", 50, -64, 255);
		BUILDER.pop();
		...
		MinHeightStibnite = BUILDER.comment("Minimum Height").defineInRange("MinHeightStibnite", 0, -64, 255);
		MaxHeightStibnite = BUILDER.comment("Maximum Height").defineInRange("MaxHeightStibnite", 60, -64, 255);
		BUILDER.pop();
		...
		MinHeightGermanite = BUILDER.comment("Minimum Height").defineInRange("MinHeightGermanite", 20, -64, 255);
		MaxHeightGermanite = BUILDER.comment("Maximum Height").defineInRange("MaxHeightGermanite", 60, -64, 255);
		BUILDER.pop();
		...
		MinHeightArgutite = BUILDER.comment("Minimum Height").defineInRange("MinHeightArgutite", 20, -64, 255);
		MaxHeightArgutite = BUILDER.comment("Maximum Height").defineInRange("MaxHeightArgutite", 60, -64, 255);
		BUILDER.pop();
		...
		MinHeightBismuthinite = BUILDER.comment("Minimum Height").defineInRange("MinHeightBismuthinite", 20, -64, 255);
		MaxHeightBismuthinite = BUILDER.comment("Maximum Height").defineInRange("MaxHeightBismuthinite", 60, -64, 255);
		BUILDER.pop();
		...
		MinHeightNative_bismuth = BUILDER.comment("Minimum Height").defineInRange("MinHeightNative_bismuth", 20, -64, 255);
		MaxHeightNative_bismuth = BUILDER.comment("Maximum Height").defineInRange("MaxHeightNative_bismuth", 60, -64, 255);
		BUILDER.pop();
		...
		MinHeightBismite = BUILDER.comment("Minimum Height").defineInRange("MinHeightBismite", 20, -64, 255);
		MaxHeightBismite = BUILDER.comment("Maximum Height").defineInRange("MaxHeightBismite", 60, -64, 255);
		BUILDER.pop();
		...
		MinHeightCassiterite = BUILDER.comment("Minimum Height").defineInRange("MinHeightCassiterite", -20, -64, 255);
		MaxHeightCassiterite = BUILDER.comment("Maximum Height").defineInRange("MaxHeightCassiterite", 80, -64, 255);
		BUILDER.pop();
		...
		MinHeightTeallite = BUILDER.comment("Minimum Height").defineInRange("MinHeightTeallite", -20, -64, 255);
		MaxHeightTeallite = BUILDER.comment("Maximum Height").defineInRange("MaxHeightTeallite", 80, -64, 255);
		BUILDER.pop();
		...
		MinHeightStannite = BUILDER.comment("Minimum Height").defineInRange("MinHeightStannite", -20, -64, 255);
		MaxHeightStannite = BUILDER.comment("Maximum Height").defineInRange("MaxHeightStannite", 80, -64, 255);
		BUILDER.pop();
		...
		MinHeightNative_tin = BUILDER.comment("Minimum Height").defineInRange("MinHeightNative_tin", -20, -64, 255);
		MaxHeightNative_tin = BUILDER.comment("Maximum Height").defineInRange("MaxHeightNative_tin", 80, -64, 255);
		BUILDER.pop();
		...
		MinHeightKesterite = BUILDER.comment("Minimum Height").defineInRange("MinHeightKesterite", -20, -64, 255);
		MaxHeightKesterite = BUILDER.comment("Maximum Height").defineInRange("MaxHeightKesterite", 40, -64, 255);
		BUILDER.pop();
		...
		MinHeightGalena = BUILDER.comment("Minimum Height").defineInRange("MinHeightGalena", 30, -64, 255);
		MaxHeightGalena = BUILDER.comment("Maximum Height").defineInRange("MaxHeightGalena", 90, -64, 255);
		BUILDER.pop();
		...
		MinHeightCerussite = BUILDER.comment("Minimum Height").defineInRange("MinHeightCerussite", 30, -64, 255);
		MaxHeightCerussite = BUILDER.comment("Maximum Height").defineInRange("MaxHeightCerussite", 90, -64, 255);
		BUILDER.pop();
		...
		MinHeightAnglesite = BUILDER.comment("Minimum Height").defineInRange("MinHeightAnglesite", 30, -64, 255);
		MaxHeightAnglesite = BUILDER.comment("Maximum Height").defineInRange("MaxHeightAnglesite", 90, -64, 255);
		BUILDER.pop();
		...
		MinHeightBoulangerite = BUILDER.comment("Minimum Height").defineInRange("MinHeightBoulangerite", 30, -64, 255);
		MaxHeightBoulangerite = BUILDER.comment("Maximum Height").defineInRange("MaxHeightBoulangerite", 90, -64, 255);
		BUILDER.pop();
		...
		MinHeightPyromorphite = BUILDER.comment("Minimum Height").defineInRange("MinHeightPyromorphite", 30, -64, 255);
		MaxHeightPyromorphite = BUILDER.comment("Maximum Height").defineInRange("MaxHeightPyromorphite", 90, -64, 255);
		BUILDER.pop();
		...
		MinHeightBauxite = BUILDER.comment("Minimum Height").defineInRange("MinHeightBauxite", 10, -64, 255);
		MaxHeightBauxite = BUILDER.comment("Maximum Height").defineInRange("MaxHeightBauxite", 95, -64, 255);
		BUILDER.pop();
		...
		MinHeightNepheline = BUILDER.comment("Minimum Height").defineInRange("MinHeightNepheline", 10, -64, 255);
		MaxHeightNepheline = BUILDER.comment("Maximum Height").defineInRange("MaxHeightNepheline", 95, -64, 255);
		BUILDER.pop();
		...
		MinHeightLeucite = BUILDER.comment("Minimum Height").defineInRange("MinHeightLeucite", 10, -64, 255);
		MaxHeightLeucite = BUILDER.comment("Maximum Height").defineInRange("MaxHeightLeucite", 95, -64, 255);
		BUILDER.pop();
		...
		MinHeightSphalerite = BUILDER.comment("Minimum Height").defineInRange("MinHeightSphalerite", 0, -64, 255);
		MaxHeightSphalerite = BUILDER.comment("Maximum Height").defineInRange("MaxHeightSphalerite", 50, -64, 255);
		BUILDER.pop();
		...
		MinHeightSmithsonite = BUILDER.comment("Minimum Height").defineInRange("MinHeightSmithsonite", 0, -64, 255);
		MaxHeightSmithsonite = BUILDER.comment("Maximum Height").defineInRange("MaxHeightSmithsonite", 50, -64, 255);
		BUILDER.pop();
		...
		MinHeightHemimorphite = BUILDER.comment("Minimum Height").defineInRange("MinHeightHemimorphite", 0, -64, 255);
		MaxHeightHemimorphite = BUILDER.comment("Maximum Height").defineInRange("MaxHeightHemimorphite", 50, -64, 255);
		BUILDER.pop();
		...
		MinHeightFranklinite = BUILDER.comment("Minimum Height").defineInRange("MinHeightFranklinite", 0, -64, 255);
		MaxHeightFranklinite = BUILDER.comment("Maximum Height").defineInRange("MaxHeightFranklinite", 50, -64, 255);
		BUILDER.pop();
		...
		MinHeightZincite = BUILDER.comment("Minimum Height").defineInRange("MinHeightZincite", 0, -64, 255);
		MaxHeightZincite = BUILDER.comment("Maximum Height").defineInRange("MaxHeightZincite", 50, -64, 255);
		BUILDER.pop();
		...
		MinHeightHydrozincite = BUILDER.comment("Minimum Height").defineInRange("MinHeightHydrozincite", 0, -64, 255);
		MaxHeightHydrozincite = BUILDER.comment("Maximum Height").defineInRange("MaxHeightHydrozincite", 50, -64, 255);
		BUILDER.pop();
		...
		MinHeightOtavite = BUILDER.comment("Minimum Height").defineInRange("MinHeightOtavite", 40, -64, 255);
		MaxHeightOtavite = BUILDER.comment("Maximum Height").defineInRange("MaxHeightOtavite", 85, -64, 255);
		BUILDER.pop();
		...
		MinHeightGreenockite = BUILDER.comment("Minimum Height").defineInRange("MinHeightGreenockite", 40, -64, 255);
		MaxHeightGreenockite = BUILDER.comment("Maximum Height").defineInRange("MaxHeightGreenockite", 85, -64, 255);
		BUILDER.pop();
		...
		MinHeightCinnabar = BUILDER.comment("Minimum Height").defineInRange("MinHeightCinnabar", 50, -64, 255);
		MaxHeightCinnabar = BUILDER.comment("Maximum Height").defineInRange("MaxHeightCinnabar", 192, -64, 255);
		BUILDER.pop();
		...
		MinHeightNative_copper = BUILDER.comment("Minimum Height").defineInRange("MinHeightNative_copper", 20, -64, 255);
		MaxHeightNative_copper = BUILDER.comment("Maximum Height").defineInRange("MaxHeightNative_copper", 80, -64, 255);
		BUILDER.pop();
		...
		MinHeightChalcopyrite = BUILDER.comment("Minimum Height").defineInRange("MinHeightChalcopyrite", 0, -64, 255);
		MaxHeightChalcopyrite = BUILDER.comment("Maximum Height").defineInRange("MaxHeightChalcopyrite", 80, -64, 255);
		BUILDER.pop();
		...
		MinHeightChalcocite = BUILDER.comment("Minimum Height").defineInRange("MinHeightChalcocite", 0, -64, 255);
		MaxHeightChalcocite = BUILDER.comment("Maximum Height").defineInRange("MaxHeightChalcocite", 80, -64, 255);
		BUILDER.pop();
		...
		MinHeightBornite = BUILDER.comment("Minimum Height").defineInRange("MinHeightBornite", 0, -64, 255);
		MaxHeightBornite = BUILDER.comment("Maximum Height").defineInRange("MaxHeightBornite", 80, -64, 255);
		BUILDER.pop();
		...
		MinHeightEnargite = BUILDER.comment("Minimum Height").defineInRange("MinHeightEnargite", 0, -64, 255);
		MaxHeightEnargite = BUILDER.comment("Maximum Height").defineInRange("MaxHeightEnargite", 80, -64, 255);
		BUILDER.pop();
		...
		MinHeightTennantite = BUILDER.comment("Minimum Height").defineInRange("MinHeightTennantite", 0, -64, 255);
		MaxHeightTennantite = BUILDER.comment("Maximum Height").defineInRange("MaxHeightTennantite", 80, -64, 255);
		BUILDER.pop();
		...
		MinHeightTetrahedrite = BUILDER.comment("Minimum Height").defineInRange("MinHeightTetrahedrite", 0, -64, 255);
		MaxHeightTetrahedrite = BUILDER.comment("Maximum Height").defineInRange("MaxHeightTetrahedrite", 80, -64, 255);
		BUILDER.pop();
		...
		MinHeightCovellite = BUILDER.comment("Minimum Height").defineInRange("MinHeightCovellite", 0, -64, 255);
		MaxHeightCovellite = BUILDER.comment("Maximum Height").defineInRange("MaxHeightCovellite", 80, -64, 255);
		BUILDER.pop();
		...
		MinHeightAzurite = BUILDER.comment("Minimum Height").defineInRange("MinHeightAzurite", 0, -64, 255);
		MaxHeightAzurite = BUILDER.comment("Maximum Height").defineInRange("MaxHeightAzurite", 80, -64, 255);
		BUILDER.pop();
		...
		MinHeightMalachite = BUILDER.comment("Minimum Height").defineInRange("MinHeightMalachite", 30, -64, 255);
		MaxHeightMalachite = BUILDER.comment("Maximum Height").defineInRange("MaxHeightMalachite", 65, -64, 255);
		BUILDER.pop();
		...
		MinHeightCuprite = BUILDER.comment("Minimum Height").defineInRange("MinHeightCuprite", 0, -64, 255);
		MaxHeightCuprite = BUILDER.comment("Maximum Height").defineInRange("MaxHeightCuprite", 80, -64, 255);
		BUILDER.pop();
		...
		MinHeightNative_silver = BUILDER.comment("Minimum Height").defineInRange("MinHeightNative_silver", -10, -64, 255);
		MaxHeightNative_silver = BUILDER.comment("Maximum Height").defineInRange("MaxHeightNative_silver", 10, -64, 255);
		BUILDER.pop();
		...
		MinHeightAcanthite = BUILDER.comment("Minimum Height").defineInRange("MinHeightAcanthite", -10, -64, 255);
		MaxHeightAcanthite = BUILDER.comment("Maximum Height").defineInRange("MaxHeightAcanthite", 10, -64, 255);
		BUILDER.pop();
		...
		MinHeightStephanite = BUILDER.comment("Minimum Height").defineInRange("MinHeightStephanite", -10, -64, 255);
		MaxHeightStephanite = BUILDER.comment("Maximum Height").defineInRange("MaxHeightStephanite", 10, -64, 255);
		BUILDER.pop();
		...
		MinHeightProustite = BUILDER.comment("Minimum Height").defineInRange("MinHeightProustite", -10, -64, 255);
		MaxHeightProustite = BUILDER.comment("Maximum Height").defineInRange("MaxHeightProustite", 10, -64, 255);
		BUILDER.pop();
		...
		MinHeightFreibergite = BUILDER.comment("Minimum Height").defineInRange("MinHeightFreibergite", -10, -64, 255);
		MaxHeightFreibergite = BUILDER.comment("Maximum Height").defineInRange("MaxHeightFreibergite", 10, -64, 255);
		BUILDER.pop();
		...
		MinHeightNickeline = BUILDER.comment("Minimum Height").defineInRange("MinHeightNickeline", 10, -64, 255);
		MaxHeightNickeline = BUILDER.comment("Maximum Height").defineInRange("MaxHeightNickeline", 30, -64, 255);
		BUILDER.pop();
		...
		MinHeightPentlandite = BUILDER.comment("Minimum Height").defineInRange("MinHeightPentlandite", 10, -64, 255);
		MaxHeightPentlandite = BUILDER.comment("Maximum Height").defineInRange("MaxHeightPentlandite", 30, -64, 255);
		BUILDER.pop();
		...
		MinHeightNepouite = BUILDER.comment("Minimum Height").defineInRange("MinHeightNepouite", 10, -64, 255);
		MaxHeightNepouite = BUILDER.comment("Maximum Height").defineInRange("MaxHeightNepouite", 30, -64, 255);
		BUILDER.pop();
		...
		MinHeightMillerite = BUILDER.comment("Minimum Height").defineInRange("MinHeightMillerite", 10, -64, 255);
		MaxHeightMillerite = BUILDER.comment("Maximum Height").defineInRange("MaxHeightMillerite", 30, -64, 255);
		BUILDER.pop();
		...
		MinHeightGersdorffite = BUILDER.comment("Minimum Height").defineInRange("MinHeightGersdorffite", 10, -64, 255);
		MaxHeightGersdorffite = BUILDER.comment("Maximum Height").defineInRange("MaxHeightGersdorffite", 30, -64, 255);
		BUILDER.pop();
		...
		MinHeightCobaltite = BUILDER.comment("Minimum Height").defineInRange("MinHeightCobaltite", -25, -64, 255);
		MaxHeightCobaltite = BUILDER.comment("Maximum Height").defineInRange("MaxHeightCobaltite", 5, -64, 255);
		BUILDER.pop();
		...
		MinHeightCarrollite = BUILDER.comment("Minimum Height").defineInRange("MinHeightCarrollite", -25, -64, 255);
		MaxHeightCarrollite = BUILDER.comment("Maximum Height").defineInRange("MaxHeightCarrollite", 5, -64, 255);
		BUILDER.pop();
		...
		MinHeightSkutterudite = BUILDER.comment("Minimum Height").defineInRange("MinHeightSkutterudite", -25, -64, 255);
		MaxHeightSkutterudite = BUILDER.comment("Maximum Height").defineInRange("MaxHeightSkutterudite", 5, -64, 255);
		BUILDER.pop();

		BUILDER.push("hematite");
		enableHematite = BUILDER.comment("Enable hematite generation").define("enableHematite", false);
		VeinSizeHematite = BUILDER.comment("Vein Size").defineInRange("VeinSizeHematite", 12, 0, 50);
		VeinsPerChunkHematite = BUILDER.comment("Veins per chunk").defineInRange("VeinsPerChunkHematite", 6, 0, 50);
		MinHeightHematite = BUILDER.comment("Minimum Height").defineInRange("MinHeightHematite", -50, -64, 255);
		MaxHeightHematite = BUILDER.comment("Maximum Height").defineInRange("MaxHeightHematite", 192, -64, 255);
		BUILDER.pop();

		BUILDER.push("magnetite");
		enableMagnetite = BUILDER.comment("Enable magnetite generation").define("enableMagnetite", false);
		VeinSizeMagnetite = BUILDER.comment("Vein Size").defineInRange("VeinSizeMagnetite", 12, 0, 50);
		VeinsPerChunkMagnetite = BUILDER.comment("Veins per chunk").defineInRange("VeinsPerChunkMagnetite", 6, 0, 50);
		MinHeightMagnetite = BUILDER.comment("Minimum Height").defineInRange("MinHeightMagnetite", -50, -64, 255);
		MaxHeightMagnetite = BUILDER.comment("Maximum Height").defineInRange("MaxHeightMagnetite", 192, -64, 255);
		BUILDER.pop();

		BUILDER.push("limonite");
		enableLimonite = BUILDER.comment("Enable limonite generation").define("enableLimonite", false);
		VeinSizeLimonite = BUILDER.comment("Vein Size").defineInRange("VeinSizeLimonite", 12, 0, 50);
		VeinsPerChunkLimonite = BUILDER.comment("Veins per chunk").defineInRange("VeinsPerChunkLimonite", 6, 0, 50);
		MinHeightLimonite = BUILDER.comment("Minimum Height").defineInRange("MinHeightLimonite", -50, -64, 255);
		MaxHeightLimonite = BUILDER.comment("Maximum Height").defineInRange("MaxHeightLimonite", 192, -64, 255);
		BUILDER.pop();

		BUILDER.push("siderite");
		enableSiderite = BUILDER.comment("Enable siderite generation").define("enableSiderite", false);
		VeinSizeSiderite = BUILDER.comment("Vein Size").defineInRange("VeinSizeSiderite", 12, 0, 50);
		VeinsPerChunkSiderite = BUILDER.comment("Veins per chunk").defineInRange("VeinsPerChunkSiderite", 6, 0, 50);
		MinHeightSiderite = BUILDER.comment("Minimum Height").defineInRange("MinHeightSiderite", -50, -64, 255);
		MaxHeightSiderite = BUILDER.comment("Maximum Height").defineInRange("MaxHeightSiderite", 192, -64, 255);
		BUILDER.pop();
		...
		VeinSizeTelluric_iron = BUILDER.comment("Vein Size").defineInRange("VeinSizeTelluric_iron", 2, 0, 50);
		VeinsPerChunkTelluric_iron = BUILDER.comment("Veins per chunk").defineInRange("VeinsPerChunkTelluric_iron", 1, 0, 50);
		MinHeightTelluric_iron = BUILDER.comment("Minimum Height").defineInRange("MinHeightTelluric_iron", -50, -64, 255);
		MaxHeightTelluric_iron = BUILDER.comment("Maximum Height").defineInRange("MaxHeightTelluric_iron", 192, -64, 255);
		BUILDER.pop();
		...
		MinHeightPyrolusite = BUILDER.comment("Minimum Height").defineInRange("MinHeightPyrolusite", -30, -64, 255);
		MaxHeightPyrolusite = BUILDER.comment("Maximum Height").defineInRange("MaxHeightPyrolusite", 20, -64, 255);
		BUILDER.pop();
		...
		MinHeightRhodochrosite = BUILDER.comment("Minimum Height").defineInRange("MinHeightRhodochrosite", -30, -64, 255);
		MaxHeightRhodochrosite = BUILDER.comment("Maximum Height").defineInRange("MaxHeightRhodochrosite", 20, -64, 255);
		BUILDER.pop();
		...
		MinHeightHollandite = BUILDER.comment("Minimum Height").defineInRange("MinHeightHollandite", -30, -64, 255);
		MaxHeightHollandite = BUILDER.comment("Maximum Height").defineInRange("MaxHeightHollandite", 20, -64, 255);
		BUILDER.pop();
		...
		MinHeightManganite = BUILDER.comment("Minimum Height").defineInRange("MinHeightManganite", -30, -64, 255);
		MaxHeightManganite = BUILDER.comment("Maximum Height").defineInRange("MaxHeightManganite", 20, -64, 255);
		BUILDER.pop();
		...
		MinHeightHausmannite = BUILDER.comment("Minimum Height").defineInRange("MinHeightHausmannite", -30, -64, 255);
		MaxHeightHausmannite = BUILDER.comment("Maximum Height").defineInRange("MaxHeightHausmannite", 20, -64, 255);
		BUILDER.pop();
		...
		MinHeightAlabandite = BUILDER.comment("Minimum Height").defineInRange("MinHeightAlabandite", -30, -64, 255);
		MaxHeightAlabandite = BUILDER.comment("Maximum Height").defineInRange("MaxHeightAlabandite", 20, -64, 255);
		BUILDER.pop();
		...
		MinHeightRhodonite = BUILDER.comment("Minimum Height").defineInRange("MinHeightRhodonite", -30, -64, 255);
		MaxHeightRhodonite = BUILDER.comment("Maximum Height").defineInRange("MaxHeightRhodonite", 20, -64, 255);
		BUILDER.pop();
		...
		MinHeightChromite = BUILDER.comment("Minimum Height").defineInRange("MinHeightChromite", -15, -64, 255);
		MaxHeightChromite = BUILDER.comment("Maximum Height").defineInRange("MaxHeightChromite", 15, -64, 255);
		BUILDER.pop();
		...
		MinHeightMolybdenite = BUILDER.comment("Minimum Height").defineInRange("MinHeightMolybdenite", -15, -64, 255);
		MaxHeightMolybdenite = BUILDER.comment("Maximum Height").defineInRange("MaxHeightMolybdenite", 25, -64, 255);
		BUILDER.pop();
		...
		MinHeightWulfenite = BUILDER.comment("Minimum Height").defineInRange("MinHeightWulfenite", -15, -64, 255);
		MaxHeightWulfenite = BUILDER.comment("Maximum Height").defineInRange("MaxHeightWulfenite", 25, -64, 255);
		BUILDER.pop();
		...
		MinHeightScheelite = BUILDER.comment("Minimum Height").defineInRange("MinHeightScheelite", 0, -64, 255);
		MaxHeightScheelite = BUILDER.comment("Maximum Height").defineInRange("MaxHeightScheelite", 25, -64, 255);
		BUILDER.pop();
		...
		MinHeightFerberite = BUILDER.comment("Minimum Height").defineInRange("MinHeightFerberite", 0, -64, 255);
		MaxHeightFerberite = BUILDER.comment("Maximum Height").defineInRange("MaxHeightFerberite", 25, -64, 255);
		BUILDER.pop();
		...
		MinHeightHubnerite = BUILDER.comment("Minimum Height").defineInRange("MinHeightHubnerite", 0, -64, 255);
		MaxHeightHubnerite = BUILDER.comment("Maximum Height").defineInRange("MaxHeightHubnerite", 25, -64, 255);
		BUILDER.pop();
		...
		MinHeightVanadinite = BUILDER.comment("Minimum Height").defineInRange("MinHeightVanadinite", -25, -64, 255);
		MaxHeightVanadinite = BUILDER.comment("Maximum Height").defineInRange("MaxHeightVanadinite", 5, -64, 255);
		BUILDER.pop();
		...
		MinHeightDescloizite = BUILDER.comment("Minimum Height").defineInRange("MinHeightDescloizite", -25, -64, 255);
		MaxHeightDescloizite = BUILDER.comment("Maximum Height").defineInRange("MaxHeightDescloizite", 5, -64, 255);
		BUILDER.pop();
		...
		MinHeightColumbite = BUILDER.comment("Minimum Height").defineInRange("MinHeightColumbite", -50, -64, 255);
		MaxHeightColumbite = BUILDER.comment("Maximum Height").defineInRange("MaxHeightColumbite", -25, -64, 255);
		BUILDER.pop();
		...
		MinHeightTantalite = BUILDER.comment("Minimum Height").defineInRange("MinHeightTantalite", -20, -64, 255);
		MaxHeightTantalite = BUILDER.comment("Maximum Height").defineInRange("MaxHeightTantalite", 0, -64, 255);
		BUILDER.pop();
		...
		MinHeightRutile = BUILDER.comment("Minimum Height").defineInRange("MinHeightRutile", -40, -64, 255);
		MaxHeightRutile = BUILDER.comment("Maximum Height").defineInRange("MaxHeightRutile", -10, -64, 255);
		BUILDER.pop();
		...
		MinHeightIlmenite = BUILDER.comment("Minimum Height").defineInRange("MinHeightIlmenite", -40, -64, 255);
		MaxHeightIlmenite = BUILDER.comment("Maximum Height").defineInRange("MaxHeightIlmenite", -10, -64, 255);
		BUILDER.pop();
		...
		MinHeightAnatase = BUILDER.comment("Minimum Height").defineInRange("MinHeightAnatase", -40, -64, 255);
		MaxHeightAnatase = BUILDER.comment("Maximum Height").defineInRange("MaxHeightAnatase", -10, -64, 255);
		BUILDER.pop();
		...
		MinHeightBrookite = BUILDER.comment("Minimum Height").defineInRange("MinHeightBrookite", -40, -64, 255);
		MaxHeightBrookite = BUILDER.comment("Maximum Height").defineInRange("MaxHeightBrookite", -10, -64, 255);
		BUILDER.pop();
		...
		MinHeightTitanite = BUILDER.comment("Minimum Height").defineInRange("MinHeightTitanite", -40, -64, 255);
		MaxHeightTitanite = BUILDER.comment("Maximum Height").defineInRange("MaxHeightTitanite", -10, -64, 255);
		BUILDER.pop();
		...
		MinHeightZircon = BUILDER.comment("Minimum Height").defineInRange("MinHeightZircon", -30, -64, 255);
		MaxHeightZircon = BUILDER.comment("Maximum Height").defineInRange("MaxHeightZircon", -5, -64, 255);
		BUILDER.pop();
		...
		MinHeightThorite = BUILDER.comment("Minimum Height").defineInRange("MinHeightThorite", -40, -64, 255);
		MaxHeightThorite = BUILDER.comment("Maximum Height").defineInRange("MaxHeightThorite", -25, -64, 255);
		BUILDER.pop();
		...
		MinHeightCarnotite = BUILDER.comment("Minimum Height").defineInRange("MinHeightCarnotite", -40, -64, 255);
		MaxHeightCarnotite = BUILDER.comment("Maximum Height").defineInRange("MaxHeightCarnotite", -10, -64, 255);
		BUILDER.pop();
		...
		MinHeightUraninite = BUILDER.comment("Minimum Height").defineInRange("MinHeightUraninite", -40, -64, 255);
		MaxHeightUraninite = BUILDER.comment("Maximum Height").defineInRange("MaxHeightUraninite", -10, -64, 255);
		BUILDER.pop();
		...
		MinHeightTorbernite = BUILDER.comment("Minimum Height").defineInRange("MinHeightTorbernite", -40, -64, 255);
		MaxHeightTorbernite = BUILDER.comment("Maximum Height").defineInRange("MaxHeightTorbernite", -10, -64, 255);
		BUILDER.pop();
		...
		MinHeightMagnesite = BUILDER.comment("Minimum Height").defineInRange("MinHeightMagnesite", 20, -64, 255);
		MaxHeightMagnesite = BUILDER.comment("Maximum Height").defineInRange("MaxHeightMagnesite", 128, -64, 255);
		BUILDER.pop();
		...
		MinHeightKieserite = BUILDER.comment("Minimum Height").defineInRange("MinHeightKieserite", 20, -64, 255);
		MaxHeightKieserite = BUILDER.comment("Maximum Height").defineInRange("MaxHeightKieserite", 128, -64, 255);
		BUILDER.pop();
		...
		MinHeightBrucite = BUILDER.comment("Minimum Height").defineInRange("MinHeightBrucite", 20, -64, 255);
		MaxHeightBrucite = BUILDER.comment("Maximum Height").defineInRange("MaxHeightBrucite", 128, -64, 255);
		BUILDER.pop();
		...
		MinHeightCalcite = BUILDER.comment("Minimum Height").defineInRange("MinHeightCalcite", 30, -64, 255);
		MaxHeightCalcite = BUILDER.comment("Maximum Height").defineInRange("MaxHeightCalcite", 192, -64, 255);
		BUILDER.pop();
		...
		MinHeightGypsum = BUILDER.comment("Minimum Height").defineInRange("MinHeightGypsum", 30, -64, 255);
		MaxHeightGypsum = BUILDER.comment("Maximum Height").defineInRange("MaxHeightGypsum", 192, -64, 255);
		BUILDER.pop();
		...
		MinHeightAnhydrite = BUILDER.comment("Minimum Height").defineInRange("MinHeightAnhydrite", 30, -64, 255);
		MaxHeightAnhydrite = BUILDER.comment("Maximum Height").defineInRange("MaxHeightAnhydrite", 192, -64, 255);
		BUILDER.pop();
		...
		MinHeightDolomite = BUILDER.comment("Minimum Height").defineInRange("MinHeightDolomite", 30, -64, 255);
		MaxHeightDolomite = BUILDER.comment("Maximum Height").defineInRange("MaxHeightDolomite", 192, -64, 255);
		BUILDER.pop();
		...
		MinHeightStrontianite = BUILDER.comment("Minimum Height").defineInRange("MinHeightStrontianite", -20, -64, 255);
		MaxHeightStrontianite = BUILDER.comment("Maximum Height").defineInRange("MaxHeightStrontianite", 0, -64, 255);
		BUILDER.pop();
		...
		MinHeightCelestine = BUILDER.comment("Minimum Height").defineInRange("MinHeightCelestine", -20, -64, 255);
		MaxHeightCelestine = BUILDER.comment("Maximum Height").defineInRange("MaxHeightCelestine", 0, -64, 255);
		BUILDER.pop();
		...
		MinHeightPolylithionite = BUILDER.comment("Minimum Height").defineInRange("MinHeightPolylithionite", -20, -64, 255);
		MaxHeightPolylithionite = BUILDER.comment("Maximum Height").defineInRange("MaxHeightPolylithionite", 10, -64, 255);
		BUILDER.pop();
		...
		MinHeightPetalite = BUILDER.comment("Minimum Height").defineInRange("MinHeightPetalite", -20, -64, 255);
		MaxHeightPetalite = BUILDER.comment("Maximum Height").defineInRange("MaxHeightPetalite", 10, -64, 255);
		BUILDER.pop();
		...
		MinHeightCarnallite = BUILDER.comment("Minimum Height").defineInRange("MinHeightCarnallite", 40, -64, 255);
		MaxHeightCarnallite = BUILDER.comment("Maximum Height").defineInRange("MaxHeightCarnallite", 192, -64, 255);
		BUILDER.pop();
		...
		MinHeightSylvite = BUILDER.comment("Minimum Height").defineInRange("MinHeightSylvite", 40, -64, 255);
		MaxHeightSylvite = BUILDER.comment("Maximum Height").defineInRange("MaxHeightSylvite", 192, -64, 255);
		BUILDER.pop();
		...
		MinHeightPolyhalite = BUILDER.comment("Minimum Height").defineInRange("MinHeightPolyhalite", 40, -64, 255);
		MaxHeightPolyhalite = BUILDER.comment("Maximum Height").defineInRange("MaxHeightPolyhalite", 192, -64, 255);
		BUILDER.pop();
		...
		MinHeightKainite = BUILDER.comment("Minimum Height").defineInRange("MinHeightKainite", 40, -64, 255);
		MaxHeightKainite = BUILDER.comment("Maximum Height").defineInRange("MaxHeightKainite", 192, -64, 255);
		BUILDER.pop();
		...
		MinHeightLangbeinite = BUILDER.comment("Minimum Height").defineInRange("MinHeightLangbeinite", 40, -64, 255);
		MaxHeightLangbeinite = BUILDER.comment("Maximum Height").defineInRange("MaxHeightLangbeinite", 192, -64, 255);
		BUILDER.pop();

		BUILDER.push("nitratine");
		enableNitratine = BUILDER.comment("Enable nitratine generation").define("enableNitratine", false);
		VeinSizeNitratine = BUILDER.comment("Vein Size").defineInRange("VeinSizeNitratine", 17, 0, 50);
		VeinsPerChunkNitratine = BUILDER.comment("Veins per chunk").defineInRange("VeinsPerChunkNitratine", 6, 0, 50);
		MinHeightNitratine = BUILDER.comment("Minimum Height").defineInRange("MinHeightNitratine", 45, -64, 255);
		MaxHeightNitratine = BUILDER.comment("Maximum Height").defineInRange("MaxHeightNitratine", 128, -64, 255);
		BUILDER.pop();
		...
		MinHeightHalite = BUILDER.comment("Minimum Height").defineInRange("MinHeightHalite", 30, -64, 255);
		MaxHeightHalite = BUILDER.comment("Maximum Height").defineInRange("MaxHeightHalite", 128, -64, 255);
		BUILDER.pop();

		BUILDER.push("sapphire_ore");
		enableSapphire_ore = BUILDER.comment("Enable sapphire generation").define("enableSapphire_ore", false);
		VeinSizeSapphire_ore = BUILDER.comment("Vein Size").defineInRange("VeinSizeSapphire_ore", 8, 0, 50);
		VeinsPerChunkSapphire_ore = BUILDER.comment("Veins per chunk").defineInRange("VeinsPerChunkSapphire_ore", 2, 0, 50);
		MinHeightSapphire_ore = BUILDER.comment("Minimum Height").defineInRange("MinHeightSapphire_ore", -60, -64, 255);
		MaxHeightSapphire_ore = BUILDER.comment("Maximum Height").defineInRange("MaxHeightSapphire_ore", 10, -64, 255);
		BUILDER.pop();

		BUILDER.push("ruby_ore");
		enableRuby_ore = BUILDER.comment("Enable ruby generation").define("enableRuby_ore", false);
		VeinSizeRuby_ore = BUILDER.comment("Vein Size").defineInRange("VeinSizeRuby_ore", 8, 0, 50);
		VeinsPerChunkRuby_ore = BUILDER.comment("Veins per chunk").defineInRange("VeinsPerChunkRuby_ore", 2, 0, 50);
		MinHeightRuby_ore = BUILDER.comment("Minimum Height").defineInRange("MinHeightRuby_ore", -60, -64, 255);
		MaxHeightRuby_ore = BUILDER.comment("Maximum Height").defineInRange("MaxHeightRuby_ore", 10, -64, 255);
		BUILDER.pop();
		...
		VeinsPerChunkSpinel_ore = BUILDER.comment("Veins per chunk").defineInRange("VeinsPerChunkSpinel_ore", 3, 0, 50);
		MinHeightSpinel_ore = BUILDER.comment("Minimum Height").defineInRange("MinHeightSpinel_ore", 4, -64, 255);
		MaxHeightSpinel_ore = BUILDER.comment("Maximum Height").defineInRange("MaxHeightSpinel_ore", 25, -64, 255);
		BUILDER.pop();
		...
		VeinsPerChunkAmethyst_ore = BUILDER.comment("Veins per chunk").defineInRange("VeinsPerChunkAmethyst_ore", 3, 0, 50);
		MinHeightAmethyst_ore = BUILDER.comment("Minimum Height").defineInRange("MinHeightAmethyst_ore", 4, -64, 255);
		MaxHeightAmethyst_ore = BUILDER.comment("Maximum Height").defineInRange("MaxHeightAmethyst_ore", 25, -64, 255);
		BUILDER.pop();

		BUILDER.push("jade_ore");
		enableJade_ore = BUILDER.comment("Enable jade generation").define("enableJade_ore", false);
		VeinSizeJade_ore = BUILDER.comment("Vein Size").defineInRange("VeinSizeJade_ore", 7, 0, 50);
		VeinsPerChunkJade_ore = BUILDER.comment("Veins per chunk").defineInRange("VeinsPerChunkJade_ore", 3, 0, 50);
		MinHeightJade_ore = BUILDER.comment("Minimum Height").defineInRange("MinHeightJade_ore", 4, -64, 255);
		MaxHeightJade_ore = BUILDER.comment("Maximum Height").defineInRange("MaxHeightJade_ore", 30, -64, 255);
		BUILDER.pop();
		...
		VeinsPerChunkTourmaline_ore = BUILDER.comment("Veins per chunk").defineInRange("VeinsPerChunkTourmaline_ore", 3, 0, 50);
		MinHeightTourmaline_ore = BUILDER.comment("Minimum Height").defineInRange("MinHeightTourmaline_ore", 4, -64, 255);
		MaxHeightTourmaline_ore = BUILDER.comment("Maximum Height").defineInRange("MaxHeightTourmaline_ore", 30, -64, 255);
		BUILDER.pop();
		...
		VeinsPerChunkSugilite_ore = BUILDER.comment("Veins per chunk").defineInRange("VeinsPerChunkSugilite_ore", 4, 0, 50);
		MinHeightSugilite_ore = BUILDER.comment("Minimum Height").defineInRange("MinHeightSugilite_ore", 4, -64, 255);
		MaxHeightSugilite_ore = BUILDER.comment("Maximum Height").defineInRange("MaxHeightSugilite_ore", 35, -64, 255);
		BUILDER.pop();
		...
		VeinsPerChunkPeridot_ore = BUILDER.comment("Veins per chunk").defineInRange("VeinsPerChunkPeridot_ore", 4, 0, 50);
		MinHeightPeridot_ore = BUILDER.comment("Minimum Height").defineInRange("MinHeightPeridot_ore", 4, -64, 255);
		MaxHeightPeridot_ore = BUILDER.comment("Maximum Height").defineInRange("MaxHeightPeridot_ore", 45, -64, 255);
		BUILDER.pop();
		...
		VeinsPerChunkAgate_ore = BUILDER.comment("Veins per chunk").defineInRange("VeinsPerChunkAgate_ore", 4, 0, 50);
		MinHeightAgate_ore = BUILDER.comment("Minimum Height").defineInRange("MinHeightAgate_ore", 4, -64, 255);
		MaxHeightAgate_ore = BUILDER.comment("Maximum Height").defineInRange("MaxHeightAgate_ore", 50, -64, 255);
		BUILDER.pop();
		...
		VeinsPerChunkCarnelian_ore = BUILDER.comment("Veins per chunk").defineInRange("VeinsPerChunkCarnelian_ore", 4, 0, 50);
		MinHeightCarnelian_ore = BUILDER.comment("Minimum Height").defineInRange("MinHeightCarnelian_ore", 4, -64, 255);
		MaxHeightCarnelian_ore = BUILDER.comment("Maximum Height").defineInRange("MaxHeightCarnelian_ore", 50, -64, 255);
		BUILDER.pop();
		...
		VeinsPerChunkChrysoprase_ore = BUILDER.comment("Veins per chunk").defineInRange("VeinsPerChunkChrysoprase_ore", 4, 0, 50);
		MinHeightChrysoprase_ore = BUILDER.comment("Minimum Height").defineInRange("MinHeightChrysoprase_ore", 4, -64, 255);
		MaxHeightChrysoprase_ore = BUILDER.comment("Maximum Height").defineInRange("MaxHeightChrysoprase_ore", 40, -64, 255);
		BUILDER.pop();
		...
		VeinsPerChunkHeliotrope_ore = BUILDER.comment("Veins per chunk").defineInRange("VeinsPerChunkHeliotrope_ore", 4, 0, 50);
		MinHeightHeliotrope_ore = BUILDER.comment("Minimum Height").defineInRange("MinHeightHeliotrope_ore", 4, -64, 255);
		MaxHeightHeliotrope_ore = BUILDER.comment("Maximum Height").defineInRange("MaxHeightHeliotrope_ore", 50, -64, 255);
		BUILDER.pop();
		...
		VeinsPerChunkTopaz_ore = BUILDER.comment("Veins per chunk").defineInRange("VeinsPerChunkTopaz_ore", 3, 0, 50);
		MinHeightTopaz_ore = BUILDER.comment("Minimum Height").defineInRange("MinHeightTopaz_ore", 4, -64, 255);
		MaxHeightTopaz_ore = BUILDER.comment("Maximum Height").defineInRange("MaxHeightTopaz_ore", 30, -64, 255);
		BUILDER.pop();
		...
		VeinsPerChunkUnakite_ore = BUILDER.comment("Veins per chunk").defineInRange("VeinsPerChunkUnakite_ore", 3, 0, 50);
		MinHeightUnakite_ore = BUILDER.comment("Minimum Height").defineInRange("MinHeightUnakite_ore", 4, -64, 255);
		MaxHeightUnakite_ore = BUILDER.comment("Maximum Height").defineInRange("MaxHeightUnakite_ore", 40, -64, 255);
		BUILDER.pop();
		...
		VeinsPerChunkTanzanite_ore = BUILDER.comment("Veins per chunk").defineInRange("VeinsPerChunkTanzanite_ore", 5, 0, 50);
		MinHeightTanzanite_ore = BUILDER.comment("Minimum Height").defineInRange("MinHeightTanzanite_ore", 4, -64, 255);
		MaxHeightTanzanite_ore = BUILDER.comment("Maximum Height").defineInRange("MaxHeightTanzanite_ore", 40, -64, 255);
		BUILDER.pop();
		...
		VeinsPerChunkHauyne_ore = BUILDER.comment("Veins per chunk").defineInRange("VeinsPerChunkHauyne_ore", 4, 0, 50);
		MinHeightHauyne_ore = BUILDER.comment("Minimum Height").defineInRange("MinHeightHauyne_ore", 4, -64, 255);
		MaxHeightHauyne_ore = BUILDER.comment("Maximum Height").defineInRange("MaxHeightHauyne_ore", 50, -64, 255);
		BUILDER.pop();
		...
		VeinsPerChunkOnyx_ore = BUILDER.comment("Veins per chunk").defineInRange("VeinsPerChunkOnyx_ore", 3, 0, 50);
		MinHeightOnyx_ore = BUILDER.comment("Minimum Height").defineInRange("MinHeightOnyx_ore", 4, -64, 255);
		MaxHeightOnyx_ore = BUILDER.comment("Maximum Height").defineInRange("MaxHeightOnyx_ore", 30, -64, 255);
		BUILDER.pop();

		BUILDER.push("opal_ore");
		enableOpal_ore = BUILDER.comment("Enable opal generation").define("enableOpal_ore", false);
		VeinSizeOpal_ore = BUILDER.comment("Vein Size").defineInRange("VeinSizeOpal_ore", 8, 0, 50);
		VeinsPerChunkOpal_ore = BUILDER.comment("Veins per chunk").defineInRange("VeinsPerChunkOpal_ore", 5, 0, 50);
		MinHeightOpal_ore = BUILDER.comment("Minimum Height").defineInRange("MinHeightOpal_ore", 4, -64, 255);
		MaxHeightOpal_ore = BUILDER.comment("Maximum Height").defineInRange("MaxHeightOpal_ore", 40, -64, 255);
		BUILDER.pop();
		...
		VeinSizeMoonstone_ore = BUILDER.comment("Vein Size").defineInRange("VeinSizeMoonstone_ore", 9, 0, 50);
		VeinsPerChunkMoonstone_ore = BUILDER.comment("Veins per chunk").defineInRange("VeinsPerChunkMoonstone_ore", 4, 0, 50);
		MinHeightMoonstone_ore = BUILDER.comment("Minimum Height").defineInRange("MinHeightMoonstone_ore", 20, -64, 255);
		MaxHeightMoonstone_ore = BUILDER.comment("Maximum Height").defineInRange("MaxHeightMoonstone_ore", 50, -64, 255);
		BUILDER.pop();
		...
		VeinSizeTurquoise_ore = BUILDER.comment("Vein Size").defineInRange("VeinSizeTurquoise_ore", 8, 0, 50);
		VeinsPerChunkTurquoise_ore = BUILDER.comment("Veins per chunk").defineInRange("VeinsPerChunkTurquoise_ore", 4, 0, 50);
		MinHeightTurquoise_ore = BUILDER.comment("Minimum Height").defineInRange("MinHeightTurquoise_ore", 20, -64, 255);
		MaxHeightTurquoise_ore = BUILDER.comment("Maximum Height").defineInRange("MaxHeightTurquoise_ore", 50, -64, 255);
		BUILDER.pop();
		...
		VeinsPerChunkAmazonite_ore = BUILDER.comment("Veins per chunk").defineInRange("VeinsPerChunkAmazonite_ore", 3, 0, 50);
		MinHeightAmazonite_ore = BUILDER.comment("Minimum Height").defineInRange("MinHeightAmazonite_ore", 10, -64, 255);
		MaxHeightAmazonite_ore = BUILDER.comment("Maximum Height").defineInRange("MaxHeightAmazonite_ore", 30, -64, 255);
		BUILDER.pop();
		...
		VeinsPerChunkChrysocolla_ore = BUILDER.comment("Veins per chunk").defineInRange("VeinsPerChunkChrysocolla_ore", 10, 0, 50);
		MinHeightChrysocolla_ore = BUILDER.comment("Minimum Height").defineInRange("MinHeightChrysocolla_ore", 10, -64, 255);
		MaxHeightChrysocolla_ore = BUILDER.comment("Maximum Height").defineInRange("MaxHeightChrysocolla_ore", 128, -64, 255);
		BUILDER.pop();
		...
		VeinSizeAlmandine_ore = BUILDER.comment("Vein Size").defineInRange("VeinSizeAlmandine_ore", 7, 0, 50);
		VeinsPerChunkAlmandine_ore = BUILDER.comment("Veins per chunk").defineInRange("VeinsPerChunkAlmandine_ore", 5, 0, 50);
		MinHeightAlmandine_ore = BUILDER.comment("Minimum Height").defineInRange("MinHeightAlmandine_ore", 4, -64, 255);
		MaxHeightAlmandine_ore = BUILDER.comment("Maximum Height").defineInRange("MaxHeightAlmandine_ore", 25, -64, 255);
		BUILDER.pop();
		...
		VeinSizeSpessartine_ore = BUILDER.comment("Vein Size").defineInRange("VeinSizeSpessartine_ore", 8, 0, 50);
		VeinsPerChunkSpessartine_ore = BUILDER.comment("Veins per chunk").defineInRange("VeinsPerChunkSpessartine_ore", 4, 0, 50);
		MinHeightSpessartine_ore = BUILDER.comment("Minimum Height").defineInRange("MinHeightSpessartine_ore", 4, -64, 255);
		MaxHeightSpessartine_ore = BUILDER.comment("Maximum Height").defineInRange("MaxHeightSpessartine_ore", 35, -64, 255);
		BUILDER.pop();

		BUILDER.push("pyrope_ore");
		enablePyrope_ore = BUILDER.comment("Enable pyrope generation").define("enablePyrope_ore", false);
		VeinSizePyrope_ore = BUILDER.comment("Vein Size").defineInRange("VeinSizePyrope_ore", 8, 0, 50);
		VeinsPerChunkPyrope_ore = BUILDER.comment("Veins per chunk").defineInRange("VeinsPerChunkPyrope_ore", 4, 0, 50);
		MinHeightPyrope_ore = BUILDER.comment("Minimum Height").defineInRange("MinHeightPyrope_ore", 4, -64, 255);
		MaxHeightPyrope_ore = BUILDER.comment("Maximum Height").defineInRange("MaxHeightPyrope_ore", 35, -64, 255);
		BUILDER.pop();
		...
		VeinSizeTsavorite_ore = BUILDER.comment("Vein Size").defineInRange("VeinSizeTsavorite_ore", 8, 0, 50);
		VeinsPerChunkTsavorite_ore = BUILDER.comment("Veins per chunk").defineInRange("VeinsPerChunkTsavorite_ore", 4, 0, 50);
		MinHeightTsavorite_ore = BUILDER.comment("Minimum Height").defineInRange("MinHeightTsavorite_ore", 4, -64, 255);
		MaxHeightTsavorite_ore = BUILDER.comment("Maximum Height").defineInRange("MaxHeightTsavorite_ore", 35, -64, 255);
		BUILDER.pop();
		...
		VeinSizeAndradite_ore = BUILDER.comment("Vein Size").defineInRange("VeinSizeAndradite_ore", 8, 0, 50);
		VeinsPerChunkAndradite_ore = BUILDER.comment("Veins per chunk").defineInRange("VeinsPerChunkAndradite_ore", 4, 0, 50);
		MinHeightAndradite_ore = BUILDER.comment("Minimum Height").defineInRange("MinHeightAndradite_ore", 4, -64, 255);
		MaxHeightAndradite_ore = BUILDER.comment("Maximum Height").defineInRange("MaxHeightAndradite_ore", 35, -64, 255);
		BUILDER.pop();
		...
		VeinsPerChunkMithril_ore = BUILDER.comment("Veins per chunk").defineInRange("VeinsPerChunkMithril", 5, 0, 50);
		MinHeightMithril_ore = BUILDER.comment("Minimum Height").defineInRange("MinHeightMithril", -60, -64, 255);
		MaxHeightMithril_ore = BUILDER.comment("Maximum Height").defineInRange("MaxHeightMithril", -35, -64, 255);
		BUILDER.pop();		
		...
		VeinSizeAdditionalPeat = BUILDER.comment("Vein Size").defineInRange("VeinSizeAdditionalPeat", 20, 0, 50);
		VeinsPerChunkAdditionalPeat = BUILDER.comment("Veins per chunk").defineInRange("VeinsPerChunkAdditionalPeat", 9, 0, 50);
		MinHeightAdditionalPeat = BUILDER.comment("Minimum Height").defineInRange("MinHeightAdditionalPeat", 45, -64, 255);
		MaxHeightAdditionalPeat = BUILDER.comment("Maximum Height").defineInRange("MaxHeightAdditionalPeat", 90, -64, 255);
		BUILDER.pop();
		...
		VeinsPerChunkPGMs = BUILDER.comment("Veins per chunk").defineInRange("VeinsPerChunkPGMs", 3, 0, 50);
		MinHeightPGMs = BUILDER.comment("Minimum Height").defineInRange("MinHeightPGMs", -60, -64, 255);
		MaxHeightPGMs = BUILDER.comment("Maximum Height").defineInRange("MaxHeightPGMs", -40, -64, 255);
		BUILDER.pop();
		...
		VeinSizeRarePGMs = BUILDER.comment("Vein Size").defineInRange("VeinSizeRarePGMs", 5, 0, 50);
		VeinsPerChunkRarePGMs = BUILDER.comment("Veins per chunk").defineInRange("VeinsPerChunkRarePGMs", 2, 0, 50);
		MinHeightRarePGMs = BUILDER.comment("Minimum Height").defineInRange("MinHeightRarePGMs", -60, -64, 255);
		MaxHeightRarePGMs = BUILDER.comment("Maximum Height").defineInRange("MaxHeightRarePGMs", -40, -64, 255);
		BUILDER.pop();		
		...
		VeinSizeBastnasite_la = BUILDER.comment("Vein Size").defineInRange("VeinSizeBastnasite_la", 7, 0, 50);	
		VeinsPerChunkBastnasite_la = BUILDER.comment("Veins per chunk").defineInRange("VeinsPerChunkBastnasite_la", 3, 0, 50);
		MinHeightBastnasite_la = BUILDER.comment("Minimum Height").defineInRange("MinHeightBastnasite_la", -40, -64, 255);
		MaxHeightBastnasite_la = BUILDER.comment("Maximum Height").defineInRange("MaxHeightBastnasite_la", 40, -64, 255);
		BUILDER.pop();
		BUILDER.push("monazite_la");
		enableMonazite_la = BUILDER.comment("Enable Monazite La generation.").define("enableMonazite_la", false);
		VeinSizeMonazite_la = BUILDER.comment("Vein Size").defineInRange("VeinSizeMonazite_la", 9, 0, 50);	
		VeinsPerChunkMonazite_la = BUILDER.comment("Veins per chunk").defineInRange("VeinsPerChunkMonazite_la", 2, 0, 50);
		MinHeightMonazite_la = BUILDER.comment("Minimum Height").defineInRange("MinHeightMonazite_la", -40, -64, 255);
		MaxHeightMonazite_la = BUILDER.comment("Maximum Height").defineInRange("MaxHeightMonazite_la", 40, -64, 255);
		BUILDER.pop();
		...
		VeinSizeBastnasite_ce = BUILDER.comment("Vein Size").defineInRange("VeinSizeBastnasite_ce", 7, 0, 50);	
		VeinsPerChunkBastnasite_ce = BUILDER.comment("Veins per chunk").defineInRange("VeinsPerChunkBastnasite_ce", 3, 0, 50);
		MinHeightBastnasite_ce = BUILDER.comment("Minimum Height").defineInRange("MinHeightBastnasite_ce", -40, -64, 255);
		MaxHeightBastnasite_ce = BUILDER.comment("Maximum Height").defineInRange("MaxHeightBastnasite_ce", 40, -64, 255);
		BUILDER.pop();
		BUILDER.push("monazite_ce");
		enableMonazite_ce = BUILDER.comment("Enable Monazite Ce generation.").define("enableMonazite_ce", false);
		VeinSizeMonazite_ce = BUILDER.comment("Vein Size").defineInRange("VeinSizeMonazite_ce", 9, 0, 50);	
		VeinsPerChunkMonazite_ce = BUILDER.comment("Veins per chunk").defineInRange("VeinsPerChunkMonazite_ce", 2, 0, 50);
		MinHeightMonazite_ce = BUILDER.comment("Minimum Height").defineInRange("MinHeightMonazite_ce", -40, -64, 255);
		MaxHeightMonazite_ce = BUILDER.comment("Maximum Height").defineInRange("MaxHeightMonazite_ce", 40, -64, 255);
		BUILDER.pop();
		...
		VeinsPerChunkBastnasite_nd = BUILDER.comment("Veins per chunk").defineInRange("VeinsPerChunkBastnasite_nd", 2, 0, 50);
		MinHeightBastnasite_nd = BUILDER.comment("Minimum Height").defineInRange("MinHeightBastnasite_nd", -40, -64, 255);
		MaxHeightBastnasite_nd = BUILDER.comment("Maximum Height").defineInRange("MaxHeightBastnasite_nd", 40, -64, 255);
		BUILDER.pop();
		BUILDER.push("monazite_nd");
		enableMonazite_nd = BUILDER.comment("Enable Monazite Nd generation.").define("enableMonazite_nd", false);
		VeinSizeMonazite_nd = BUILDER.comment("Vein Size").defineInRange("VeinSizeMonazite_nd", 8, 0, 50);	
		VeinsPerChunkMonazite_nd = BUILDER.comment("Veins per chunk").defineInRange("VeinsPerChunkMonazite_nd", 2, 0, 50);
		MinHeightMonazite_nd = BUILDER.comment("Minimum Height").defineInRange("MinHeightMonazite_nd", -40, -64, 255);
		MaxHeightMonazite_nd = BUILDER.comment("Maximum Height").defineInRange("MaxHeightMonazite_nd", 40, -64, 255);
		BUILDER.pop();
		...
		VeinsPerChunkBastnasite_y = BUILDER.comment("Veins per chunk").defineInRange("VeinsPerChunkBastnasite_y", 3, 0, 50);
		MinHeightBastnasite_y = BUILDER.comment("Minimum Height").defineInRange("MinHeightBastnasite_y", -40, -64, 255);
		MaxHeightBastnasite_y = BUILDER.comment("Maximum Height").defineInRange("MaxHeightBastnasite_y", 40, -64, 255);
		BUILDER.pop();
		...
		VeinsPerChunkSamarskite_y = BUILDER.comment("Veins per chunk").defineInRange("VeinsPerChunkSamarskite_y", 3, 0, 50);
		MinHeightSamarskite_y = BUILDER.comment("Minimum Height").defineInRange("MinHeightSamarskite_y", -40, -64, 255);
		MaxHeightSamarskite_y = BUILDER.comment("Maximum Height").defineInRange("MaxHeightSamarskite_y", 40, -64, 255);
		BUILDER.pop();
		...
		VeinsPerChunkThortveitite = BUILDER.comment("Veins per chunk").defineInRange("VeinsPerChunkThortveitite", 3, 0, 50);
		MinHeightThortveitite = BUILDER.comment("Minimum Height").defineInRange("MinHeightThortveitite", 3, -64, 255);
		MaxHeightThortveitite = BUILDER.comment("Maximum Height").defineInRange("MaxHeightThortveitite", 60, -64, 255);
		BUILDER.pop();
