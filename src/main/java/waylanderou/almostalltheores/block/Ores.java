...
public class Ores {
	...
	public static class OresRegistryEvents{		
		...
		public static void registerBlocks(RegistryEvent.Register<Block> event) {
			...
			registerBlock(event, 2, "cassiterite");
			registerBlock(event, 2, "teallite");
			registerBlock(event, 2, "stannite");
			registerBlock(event, 2, "native_tin");
			registerBlock(event, 2, "kesterite");
			registerBlock(event, 2, "galena");
			registerBlock(event, 2, "cerussite");
			registerBlock(event, 2, "anglesite");
			registerBlock(event, 2, "boulangerite");
			registerBlock(event, 2, "pyromorphite");
			registerBlock(event, 2, "bauxite");
			registerBlock(event, 2, "nepheline");
			registerBlock(event, 2, "leucite");
			registerBlock(event, 2, "sphalerite");
			registerBlock(event, 2, "smithsonite");
			registerBlock(event, 2, "hemimorphite");
